...
%global pkg_name kartech_linear_actuator_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-kartech-linear-actuator-msgs
Version:        4.0.0
Release:        5%{?dist}
...
%changelog
* Wed Apr 29 2026 AutonomouStuff Software Team <support@autonomoustuff.com> - 4.0.0-5
- Autogenerated by Bloom

* Tue Apr 28 2026 AutonomouStuff Software Team <support@autonomoustuff.com> - 4.0.0-4
- Autogenerated by Bloom

* Tue Apr 21 2026 AutonomouStuff Software Team <support@autonomoustuff.com> - 4.0.0-3
- Autogenerated by Bloom
