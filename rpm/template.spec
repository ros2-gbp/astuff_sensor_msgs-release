...
%global pkg_name neobotix_usboard_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-neobotix-usboard-msgs
Version:        4.0.0
Release:        5%{?dist}
Summary:        ROS %{pkg_name} package

License:        MIT
URL:            http://wiki.ros.org/neobotix_usboard_msgs
...
%changelog
* Wed Apr 29 2026 AutonomouStuff Software Team <software@autonomoustuff.com> - 4.0.0-5
- Autogenerated by Bloom

* Tue Apr 28 2026 AutonomouStuff Software Team <software@autonomoustuff.com> - 4.0.0-4
- Autogenerated by Bloom

* Tue Apr 21 2026 AutonomouStuff Software Team <software@autonomoustuff.com> - 4.0.0-3
- Autogenerated by Bloom
